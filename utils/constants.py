...
FORBIDDEN_URL_PATTERNS = [
    ...
    "/el-roto.html",
    "/ultima-hora-",
    "/audiencias-canales/" "/el-observatorio/",
    "/imagenes/",
    "/blog/al-dia/",
    "/videos/",
    "/comprar/",
...
FORBIDDEN_TITLE_PATTERNS = ["Podcast |", "DIRECTO |", "última hora"]
...
# HTML patterns that indicate paywall (for when paywall patterns are not in the article text)
PAYWALL_HTML_PATTERNS = [
    "<span>Artículo solo para suscriptores</span>",  # ABC
    '<div class="ue-c-article__premium">',  # El Mundo
]

AGENCIAS = ["agenciasinc", "efe"]

FORBIDDEN_AUTHOR_PATTERNS = ["EFE", "Europa Press", "Agencia", "Sinc"]
