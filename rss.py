...
if __name__ == "__main__":
	...
	destiny_path = "lazarobot/tobepredicted/" + today.strftime('%d%m%Y') + "/"
	indices_path = "lazarobot/indices/"
	already_crawled = pd.read_csv(ALREADY_SEEN_CSV, error_bad_lines=False)
