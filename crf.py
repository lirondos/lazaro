...
def write_predictions(predicted_docs):
    ...
    with open("lazarobot/tobetweeted/tobetweeted_" + TODAY +'.csv', 'a', encoding = "utf-8", newline='') as tobetweeted, open(ANGLICISM_INDEX, 'a', encoding="utf-8", newline='') as anglicism_index:
        ...
        for mydoc in predicted_docs:
            ...
            with open("lazarobot/corpus/automatically_annotated/" + TODAY + '.jsonl', 'a', encoding = "utf-8") as f:
...
if __name__ == "__main__":
    ...
    if not args.val_folder and not args.cross_validation:# we are  in test
        path_to_test = "lazarobot/tobepredicted/" + TODAY + "/"
